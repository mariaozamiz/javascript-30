...
const modernInventors = inventors.filter(
    (inventor) => inventor.year >= 1500 && inventor.year < 1600
);
console.table(modernInventors);

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names

const fullInventorsNames = inventors.map(
    (inventor) => inventor.first + ' ' + inventor.last
);
console.table(fullInventorsNames);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest

const inventorsByBirthdate = inventors;
inventorsByBirthdate.sort((a, b) => (a.year > b.year ? 1 : -1));
...
const peopleByLastName = people.sort((a, b) => (a.people > b.people ? -1 : 1));
...
const transportation = data.reduce((object, vehicle) => {
    if (!object[vehicle]) {
        object[vehicle] = 0;
    }
    object[vehicle]++;
